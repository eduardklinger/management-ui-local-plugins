...
export const CyanCatRainView: FC = () => {
  ...
  useEffect(() => {
    const cleanup = window.setInterval(() => {
      const now = Date.now();
      setCats((previous) => previous.filter((cat) => now - cat.bornAt < cat.lifetimeMs + 400));
    }, 220);
    ...
    <div className="container mx-auto p-6 space-y-6 text-slate-900">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Demo plugin for development to production workflow walkthroughs.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Press the buttons and watch the chaos.</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Useful during a live demo.</CardDescription>
          </CardHeader>
          <CardContent>
...
export default CyanCatRainView;
