...
import { usePluginTranslation, createOrganizationNamespace } from "@oc-mui/i18n";
import { NavMain, type NavMainProps } from "@oc-mui/ui/components";
...
export const CustomNavMain = (props: NavMainProps) => {
  ...
  return (
    <NavMain
      ...
      menuClassName={cn("univie-sidebar-nav flex flex-col gap-1", props.open && "gap-0")}
